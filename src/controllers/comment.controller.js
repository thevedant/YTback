...
const addComment = asyncHandler(async(req,res)=>{
    ...
    .status(200)
    .json(
        new ApiResponse(200 , comment , "Commented succesfully")
    )
})
...
const getVideoComment = asyncHandler(async(req,res)=>{
    ...
    const totalPages = await Math.ceil( totalComments/pageLimit )

    return res
    .status(200)
    .json(
        new ApiResponse( 200, {comments ,totalComments ,totalPages} , "All Comments fetched succesfully")
    )
})
